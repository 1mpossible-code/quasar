...
df = pd.read_csv('time_to_test_data.csv')
...
plt.ylabel('Time (seconds)') # Mention that time is in seconds on the graph
...
plt.savefig('time/time_test_plot.png')
...
stats_df.to_csv('time/time_test_stats.csv', index=False)
